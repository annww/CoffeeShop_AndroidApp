package ntu.duongthianhhong.blueymovies_64130758;
...
public class FirebaseDBConnection {
    ...
    public static final String DB_URL = "https://moviesapp64130758-default-rtdb.firebaseio.com/";
    ...
    private void initFirebase() {
        ...
        if (database == null) {
            // Khởi tạo Firebase
            database = FirebaseDatabase.getInstance("https://moviesapp64130758-default-rtdb.firebaseio.com/");
