//package ntu.duongthianhhong.blueymovies.Activities.Domains;
//
...
//
//    public static final String DB_URL = "https://movies-app-6392c-default-rtdb.firebaseio.com/";
//
//    // singleton
...
//        return instance;
//    }
//    // Hàm này sử dụng để khởi tạo kết nối với Firebase Database
//    private void initFirebase() {
//        // Kiểm tra xem Firebase đã được khởi tạo chưa
//        if (database == null) {
//            // Khởi tạo Firebase
//            database = FirebaseDatabase.getInstance("https://movies-app-6392c-default-rtdb.firebaseio.com/");
